            ...
            if target is not None:
                ...
                if want_content: 
                    content_instruction = (
                        ...
                        "*(หมายเหตุ: ต้องเน้น **ตัวหนา** ที่คำศัพท์แพทย์หรือคำสำคัญเสมอ เพื่อให้ผู้อ่านไม่ข้ามคำสำคัญและจดจำได้นาน และถ้าเนื้อหาหน้านั้นเป็นข้อสอบให้บอกด้วยว่าเฉลยข้อไหน A ,B, C, D,E)*"
                    )
